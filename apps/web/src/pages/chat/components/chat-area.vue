        ...
        <div class=" mx-auto">
          ...
          <section>
            <InputGroup class="bg-transparent overflow-hidden">
              ...
              <InputGroupAddon
                align="block-end"
                class="bg-[#FAFAFA] items-center py-2"
              >
                <Button
                  v-if="!streaming"
                  type="button"
...
import { ScrollArea, Button, InputGroup, InputGroupAddon, InputGroupTextarea, Sheet, SheetContent, SheetHeader, SheetTitle, SheetDescription,Separator } from '@memoh/ui'
